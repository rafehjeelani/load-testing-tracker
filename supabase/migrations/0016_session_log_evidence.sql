-- Adds comment/evidence_paths to rpc_get_candidate_state's step_report_history
-- payload -- the Session Log needs them so clicking a past attempt's step
-- can show what was actually submitted for it, not just the outcome/time.
