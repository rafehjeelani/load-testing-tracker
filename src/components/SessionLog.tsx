 ...
 *  latest. Clicking a step entry expands it to show what was actually
 *  submitted for that attempt (comment + evidence) -- disconnection entries
 *  aren't expandable here since their detail already lives in Issues &
 *  Disconnections below. Shared by the candidate's own Preview and the
 *  staff (admin/moderator) candidate-editing view, so both see the same
 *  history. */
  ...
  return (
    <div className="bg-surface border border-border rounded-[10px] p-5 mt-5">
      ...
      <div className="text-[12.5px] text-text-3 mb-3.5">
        ...
        disconnection came in between. Click a step to see what was submitted for it.
      </div>
